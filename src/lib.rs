...
#[derive(Debug)]
pub struct PhotoZipProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PhotoZipProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PhotoZip processing");
    
    let mut processor = PhotoZipProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PhotoZipProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PhotoZipProcessor::new(false);
